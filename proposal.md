...
**Evaluación de requerimientos de complejidad**
...
- ✅ Dificultad real de limpieza y modelado: valores faltantes no aleatorios,
  necesidad de evaluar correlación de datos entre tablas, alto riesgo de *leakage* temporal, variables categóricas de alta cardinalidad (`dest`, `tailnum`) y desbalance de clases.
